...
void setup()
{
  ...
  AsyncESP32_ENC_Manager AsyncESP32_ENC_manager(&webServer, NULL, "AsyncCP-ParamsOnSW");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_ENC_Manager AsyncESP32_ENC_manager(&webServer, &dnsServer, "AsyncCP-ParamsOnSW");
#endif
