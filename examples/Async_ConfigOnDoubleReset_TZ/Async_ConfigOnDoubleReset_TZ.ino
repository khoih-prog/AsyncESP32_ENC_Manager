...
void setup()
{
  ...
  AsyncESP32_ENC_Manager AsyncESP32_ENC_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_ENC_Manager AsyncESP32_ENC_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
