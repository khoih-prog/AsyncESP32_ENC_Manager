...
1. For example, you already downloaded data files from [Async_ESP32_FSWebServer_DRD data](https://github.com/khoih-prog/AsyncESP32_ENC_Manager/tree/main/examples/Async_ESP32_FSWebServer_DRD/data) to a local folder, for example:

```
~/Arduino/libraries/AsyncESP32_ENC_Manager-main/examples/Async_ESP32_FSWebServer_DRD/data
```
...
```
Ubuntu$ cd ~/Arduino/libraries/AsyncESP32_ENC_Manager-main/examples/Async_ESP32_FSWebServer_DRD/data
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_ENC_Manager/raw/main/examples/Async_ESP32_FSWebServer_DRD/pics/async-esp32fs.local.png">
</p>

4. Edit / Delete / Download any file in the the folder by going to http://async-esp32fs.local/edit

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_ENC_Manager/raw/main/examples/Async_ESP32_FSWebServer_DRD/pics/async-esp32fs.local_edit.png">
</p>
