/****************************************************************************************************************************
  AsyncESP32_ENC_Manager_Impl.h

  For Ethernet shields using ESP32_ENC (ESP32 + ENC28J60)

  AsyncESP32_ENC_Manager is a library for the ESP32 with Ethernet ENC28J60 to run Async Credential Manager
  ...
  Built by Khoi Hoang https://github.com/khoih-prog/AsyncESP32_ENC_Manager
  ...
  ------- -----------  ---------- -----------
  1.0.0   K Hoang     09/12/2022 Initial coding for ESP32_ENC
 *****************************************************************************************************************************/

#pragma once

#ifndef AsyncESP32_ENC_Manager_Impl_h
#define AsyncESP32_ENC_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESPAsync_EMParameter** AsyncESP32_ENC_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int AsyncESP32_ENC_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* AsyncESP32_ENC_Manager::getRFC952_hostname(const char* iHostname)
{
...
AsyncESP32_ENC_Manager::AsyncESP32_ENC_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver,
...
AsyncESP32_ENC_Manager::~AsyncESP32_ENC_Manager()
{
#if USE_DYNAMIC_PARAMS
...
#if USE_DYNAMIC_PARAMS
  bool AsyncESP32_ENC_Manager::addParameter(ESPAsync_EMParameter *p)
#else
  void AsyncESP32_ENC_Manager::addParameter(ESPAsync_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void AsyncESP32_ENC_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&AsyncESP32_ENC_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/eth",     std::bind(&AsyncESP32_ENC_Manager::handleETH,        this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/ethsave", std::bind(&AsyncESP32_ENC_Manager::handleETHSave,    this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/close",    std::bind(&AsyncESP32_ENC_Manager::handleServerClose, this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/i",        std::bind(&AsyncESP32_ENC_Manager::handleInfo,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/r",        std::bind(&AsyncESP32_ENC_Manager::handleReset,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/state",    std::bind(&AsyncESP32_ENC_Manager::handleState,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&AsyncESP32_ENC_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->onNotFound (std::bind(&AsyncESP32_ENC_Manager::handleNotFound,        this, std::placeholders::_1));
...
bool AsyncESP32_ENC_Manager::startConfigPortal()
{
  connect = false;
...
void AsyncESP32_ENC_Manager::setTimeout(const unsigned long& seconds)
{
...
void AsyncESP32_ENC_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void AsyncESP32_ENC_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void AsyncESP32_ENC_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void AsyncESP32_ENC_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void AsyncESP32_ENC_Manager::reportStatus(String& page)
{
...
void AsyncESP32_ENC_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void AsyncESP32_ENC_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void AsyncESP32_ENC_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void AsyncESP32_ENC_Manager::handleRoot(AsyncWebServerRequest *request)
{
...
void AsyncESP32_ENC_Manager::handleETH(AsyncWebServerRequest *request)
{
...
void AsyncESP32_ENC_Manager::handleETHSave(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("ETH save"));
...
void AsyncESP32_ENC_Manager::handleServerClose(AsyncWebServerRequest *request)
{
...
void AsyncESP32_ENC_Manager::handleInfo(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about AsyncESP32_ENC_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/AsyncESP32_ENC_Manager\">https://github.com/khoih-prog/AsyncESP32_ENC_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void AsyncESP32_ENC_Manager::handleState(AsyncWebServerRequest *request)
{
...
void AsyncESP32_ENC_Manager::handleReset(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Reset"));
...
void AsyncESP32_ENC_Manager::handleNotFound(AsyncWebServerRequest *request)
{
  if (captivePortal(request))
  {
...
*/
bool AsyncESP32_ENC_Manager::captivePortal(AsyncWebServerRequest *request)
{
...
void AsyncESP32_ENC_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void AsyncESP32_ENC_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool AsyncESP32_ENC_Manager::isIp(const String& str)
{
...
// IP to String
String AsyncESP32_ENC_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // AsyncESP32_ENC_Manager_Impl_h
