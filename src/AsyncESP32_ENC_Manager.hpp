...
#ifndef AsyncESP32_ENC_Manager_hpp
#define AsyncESP32_ENC_Manager_hpp
...
#define ASYNC_ESP32_ENC_MANAGER_VERSION           "AsyncESP32_ENC_Manager v1.0.0"

#define ASYNC_ESP32_ENC_MANAGER_VERSION_MAJOR     1
#define ASYNC_ESP32_ENC_MANAGER_VERSION_MINOR     0
#define ASYNC_ESP32_ENC_MANAGER_VERSION_PATCH     0

#define ASYNC_ESP32_ENC_MANAGER_VERSION_INT       1000000

////////////////////////////////////////////////////

#include "AsyncESP32_ENC_Manager_Debug.h"
...
class ESPAsync_EMParameter 
{
  ...
  private:
    ...
    friend class AsyncESP32_ENC_Manager;
};
...
class AsyncESP32_ENC_Manager
{
  public:

    AsyncESP32_ENC_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver, const char *iHostname = "");
...
#endif    // AsyncESP32_ENC_Manager_hpp
